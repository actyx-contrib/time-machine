...
import { PickerFishState, PickerFishEvent, SetStateEvent, PickerFishTag } from './types'
...
export const mkPickerFish = (machineID: string): Fish<PickerFishState, PickerFishEvent> => ({
